...
storiesOf("Atoms|SearchBar", module)
  ...
  .add(
    ...
    () => ({
      ...
      components: { SfSearchBar },
      template: "<sf-search-bar :class='customClass'/>"
    }),
    {
  ...
  .add(
    ...
    () => ({
      components: { SfSearchBar },
      template: `<sf-search-bar @input="action" @keyup.enter="action" @keyup.esc="action" @blur="blur"></sf-search-bar>`,
