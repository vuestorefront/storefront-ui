<template>
  <button
    ...
    :disabled="disabled"
    :class="buttonType"
    class="inline-flex items-center justify-center cursor-pointer uppercase font-body text-base font-medium px-[14px] py-2 rounded-md disabled:cursor-not-allowed outline-violet"
    v-on="$listeners"
  >
    <slot />
  </button>
