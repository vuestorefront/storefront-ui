  ...
  >
    <div class="relative">
      <input
        ...
        type="search"
        :disabled="disabled"
        class="w-full h-10 pl-4 text-gray-900 border border-gray-200 disabled:bg-gray-100
        disabled:pointer-events-none disabled:opacity-50 peer rounded-l-md hover:border-primary-500
        active:border-2 active:border-r-0 focus:border-primary-500 focus:border-2 focus:border-r-0
        remove-default-styling outline-violet"
