    ...
    <ol class="flex w-auto text-sm font-normal leading-none text-gray-500 font-body">
      ...
      >
        <slot name="icon">
          <a
            v-focus
            href="/"
            class="leading-5 rounded-sm whitespace-nowrap hover:underline active:font-medium
      ...
      >
        <a
          v-focus
          :href="link"
          class="leading-5 rounded-sm whitespace-nowrap hover:text-primary-600 hover:underline
          active:font-medium active:text-gray-900 active:no-underline outline-violet"
        >{{ name }}</a>
      </li>
    </ol>
  </nav>
