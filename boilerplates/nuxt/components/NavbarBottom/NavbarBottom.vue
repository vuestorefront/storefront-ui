<template>
  <nav class="fixed bottom-0 w-full">
    <ul
      class="grid grid-flow-col bg-white auto-cols-fr justify-items-stretch"
      :class="{'!bg-brand': type === 'secondary'}"
    >
      <slot>
        <li
          class="flex"
          :aria-label="!withText ? 'home' : false"
        >
          <a
            href="#"
            class="flex flex-col items-center justify-center flex-1 pt-3 pb-1 group
            hover:bg-primary-100 active:bg-primary-100"
            :class="{
              'hover:!bg-primary-600 active:!bg-primary-600': type === 'secondary',
              '!px-[26px] !py-[14px]': !withText
            }"
          >
            ...
            <span
              v-if="withText"
              class="text-xs font-medium text-primary-500 mt-[2px] group-hover:text-primary-600
        ...
        <li
          class="flex"
          :aria-label="!withText ? 'products' : false"
        >
          <a
            href="#"
            class="flex flex-col items-center justify-center flex-1 pt-3 pb-1 group hover:bg-primary-100
        ...
        <li
          class="flex"
          :aria-label="!withText ? 'search' : false"
        >
          <a
            href="#"
            class="flex flex-col items-center justify-center flex-1 pt-3 pb-1 group hover:bg-primary-100
        ...
        <li
          class="flex"
          :aria-label="!withText ? 'cart' : false"
        >
          <a
            href="#"
            class="flex flex-col items-center justify-center flex-1 pt-3
            pb-1 group hover:bg-primary-100 active:bg-primary-100"
            :class="{
              'hover:!bg-primary-600 active:!bg-primary-600': type === 'secondary',
              '!px-[26px] !py-[14px]': !withText
            }"
          >
            <span class="relative">
              ...
              <span
                class="absolute bottom-3 left-3 px-1 py-[2px] text-[8px] leading-[8px] bg-secondary-700 rounded-lg
                font-body !text-white font-medium border-2 border-white group-hover:border-primary-100
                group-active:border-primary-100"
                :class="{
                  // eslint-disable-next-line max-len
                  '!text-black !bg-white !border-brand group-hover:!border-primary-600 group-active:!border-primary-600': type === 'secondary'}"
              >
                123
              </span>
            </span>
        ...
        <li
          class="flex"
          :aria-label="!withText ? 'list' : false"
        >
          <a
            href="#"
            class="flex flex-col items-center justify-center flex-1 pt-3 pb-1 group hover:bg-primary-100
