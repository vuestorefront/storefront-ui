<template>
  <div>
    ...
    <div class="large:grid large:grid-cols-[minmax(615px,_1fr)_minmax(315px,_613px)]">
      ...
      <div
        class="p-4 bg-white border-gray-100 rounded-md
      justify-self-start medium:p-6 large:p-4 large:mx-4
      extra-large:p-6 shadow-large large:sticky large:self-start
      large:top-0"
      >
        ...
        <div class="flex items-center mt-1">
          ...
          <a
            ...
            class="block ml-2 text-xs
          font-normal leading-4 text-gray-500 underline font-body"
          >
          ...
          >
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M17.1673 3.33366H12.834C12.5007 2.33366 11.584 1.66699 10.5007 1.66699C9.41732 1.66699 8.50065 2.33366 8.16732 3.33366H3.83398C3.33398 3.33366 3.00065 3.66699 3.00065 4.16699C3.00065 4.66699 3.33398 5.00033 3.83398 5.00033H8.16732C8.50065 6.00033 9.41732 6.66699 10.5007 6.66699C11.584 6.66699 12.5007 6.00033 12.834 5.00033H17.1673C17.6673 5.00033 18.0006 4.66699 18.0006 4.16699C18.0006 3.66699 17.6673 3.33366 17.1673 3.33366ZM10.5007 5.00033C10.0006 5.00033 9.66732 4.66699 9.66732 4.16699C9.66732 3.66699 10.0006 3.33366 10.5007 3.33366C11.0007 3.33366 11.334 3.66699 11.334 4.16699C11.334 4.66699 11.0007 5.00033 10.5007 5.00033Z"
                fill="#02BB4D"
              />
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M6.53517 6.5276C6.36306 6.10782 5.95434 5.83366 5.50065 5.83366C5.04696 5.83366 4.63825 6.10782 4.46614 6.5276L1.33398 14.167C1.33398 16.5003 3.16732 18.3337 5.50065 18.3337C7.83398 18.3337 9.66732 16.5003 9.66732 14.167L6.53517 6.5276ZM3.00065 14.167L5.50065 7.50033L8.00065 14.167H3.00065Z"
                fill="#02BB4D"
              />
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M14.3719 6.57211C14.5503 6.12611 14.9823 5.83366 15.4627 5.83366C15.9393 5.83366 16.3687 6.12171 16.5496 6.56275L19.6673 14.167C19.6673 16.5003 17.834 18.3337 15.5006 18.3337C13.1673 18.3337 11.334 16.5003 11.334 14.167L14.3719 6.57211ZM15.5006 7.50033L13.0007 14.167H18.0006L15.5006 7.50033Z"
                fill="#02BB4D"
              />
            </svg>
            <!-- eslint-enable max-len -->
          ...
          >
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M16.8861 4.15855C14.6861 2.65855 11.9694 3.35855 10.5028 5.07522C9.03612 3.35855 6.31945 2.65022 4.11945 4.15855C2.95278 4.95855 2.21945 6.30855 2.16945 7.73355C2.05278 10.9669 4.91945 13.5586 9.29445 17.5336L9.37778 17.6086C10.0111 18.1836 10.9861 18.1836 11.6194 17.6002L11.7111 17.5169C16.0861 13.5502 18.9445 10.9586 18.8361 7.72522C18.7861 6.30855 18.0528 4.95855 16.8861 4.15855ZM10.5861 16.2919L10.5028 16.3752L10.4194 16.2919C6.45278 12.7002 3.83612 10.3252 3.83612 7.91689C3.83612 6.25022 5.08612 5.00022 6.75278 5.00022C8.03612 5.00022 9.28612 5.82522 9.72778 6.96689H11.2861C11.7194 5.82522 12.9694 5.00022 14.2528 5.00022C15.9194 5.00022 17.1694 6.25022 17.1694 7.91689C17.1694 10.3252 14.5528 12.7002 10.5861 16.2919Z"
                fill="#02BB4D"
              />
            </svg>
            <!-- eslint-enable max-len -->
      ...
      <div id="shopping-options" class="px-4">
        ...
        >
          ...
          <span class="block">
            Most items sold & shipped can be returned for free, either to a store
            or by mail. We handle the delivery, returns and customer service for
            these items. Items purchased in store or items picked up or delivered from a store can
            only be returned to a store.
          </span>
          <ButtonBase
            type="tertiary"
            size="small"
    ...
    <a
      ...
      class="medium:hidden mb-20 inline-flex items-center justify-center
      rounded-md cursor-pointer font-body disabled:cursor-not-allowed fixed
      bottom-0 left-[50%] translate-x-[-50%] py-3 pl-2 pr-4 font-medium text-white
      uppercase bg-primary-500 hover:bg-primary-600 active:bg-primary-700
       disabled:bg-gray-200 disabled:text-gray-500 disabled:opacity-50
        shadow-base hover:shadow-medium disabled:shadow-none"
    >
      <!-- eslint-disable max-len -->
      <svg
        width="24"
