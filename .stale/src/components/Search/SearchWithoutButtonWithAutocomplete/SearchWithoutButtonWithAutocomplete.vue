  ...
  <div class="flex flex-col onFocus" role="search">
    ...
    >
      <input
        ...
        type="search"
        :disabled="disabled"
        class="w-full h-10 pl-12 text-gray-900 border border-gray-200 rounded-md
        disabled:bg-gray-100 disabled:pointer-events-none disabled:opacity-50 peer
        hover:border-primary-500 active:border-2 remove-default-styling outline-violet"
...
export default {
  name: 'SearchWithoutButtonWithAutocomplete',
  directives: {
    focus,
  },
  components: {
