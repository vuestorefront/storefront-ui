<template>
  ...
  >
    <input
      ...
      :disabled="disabled"
      type="search"
      class="w-full h-10 pl-4 text-gray-900 border border-gray-200 rounded-md
      disabled:bg-gray-100 disabled:pointer-events-none disabled:opacity-50
      peer hover:border-primary-500 active:border-2 remove-default-styling outline-violet"
