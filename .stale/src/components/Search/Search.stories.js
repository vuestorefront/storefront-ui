import ButtonPrimaryIcons from '../Button/ButtonIcons/ButtonIcons.vue';
import SearchBase from './SearchBase/SearchBase.vue';
import SearchWithoutButton from './SearchWithoutButton/SearchWithoutButton.vue';
import SearchWithoutButtonWithAutocomplete from './SearchWithoutButtonWithAutocomplete/SearchWithoutButtonWithAutocomplete.vue';
import SearchBaseWithAutocomplete from './SearchBaseWithAutocomplete/SearchBaseWithAutocomplete.vue';
...
const BaseAutocomplete = (args, { argTypes }) => ({
  ...
  methods: {
    searchTerms(term) {
      ...
      this.searchHints = searchingHints.filter((val) => {
