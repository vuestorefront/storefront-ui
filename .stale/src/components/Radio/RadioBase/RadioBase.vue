<template>
  <div class="grid max-w-xs grid-cols-[24px_1fr] gap-x-2.5 py-3.5">
    <input
      ...
      :required="required"
      :checked="isChecked"
      class="w-5 h-5 mt-px border-2 border-gray-500 rounded-full appearance-none cursor-pointer peer
      hover:border-primary-500 checked:bg-primary-500 checked:border-primary-500 checked:shadow-inset
