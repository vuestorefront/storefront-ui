<template>
  ...
  >
    <input
      ...
      :disabled="disabled"
      :invalid="invalid"
      class="peer flex self-center w-[18px] h-[18px] border-2 border-gray-500 rounded-sm appearance-none cursor-pointer
      ...
      :class="{
        'bg-indeterminate-checkbox border-primary-500': indeterminate,
        '!border-[#b8b8bc] bg-indeterminate-disabled-checkbox': indeterminate && disabled,
        'border-negative-600': invalid, 'col-start-[end-col] row-start-[start-row]': rightCheckbox
      }"
    >
    <label
      for="checkbox"
      class="text-gray-900 flex self-center cursor-pointer font-body peer-required:after:content-['*']
      peer-disabled:text-gray-900/40 peer-disabled:cursor-not-allowed"
