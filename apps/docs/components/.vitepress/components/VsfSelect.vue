...
onChange?: (...args: any[]) => void;
    ...
    export default {
      ...
      props: ["value","options","required","disabled","label","helpText","requiredText","placeholderText","errorText","invalid","onChange","modelValue","name"],
...
return classStringFromArray(['order-3 mt-1 text-sm font-medium text-negative-600 peer-disabled:cursor-not-allowed', this.invalid ? 'block' : 'hidden']);
},  vueProxyValue: {
  get: function () {
