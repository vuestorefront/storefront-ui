<template>
  <footer class="pt-10 bg-gray-100">
    ...
    >
      <div
        class="min-w-[120px] extra-small:min-w-[172px]"
    ...
    <div class="py-10 large:flex border-t-[1px] border-gray-200">
      ...
      >
        <vsf-icon-help size="lg" v-if="index === 0"></vsf-icon-help>

        <vsf-icon-chat size="lg" v-if="index === 1"></vsf-icon-chat>

        <vsf-icon-phone size="lg" v-if="index === 2"></vsf-icon-phone>
    ...
    <div class="justify-end px-4 py-10 bg-gray-900 large:flex large:py-6">
      <div class="flex justify-center py-2 large:self-start">
        ...
        >
          <vsf-icon-facebook
            v-if="element.label.toLowerCase() === 'facebook'"
          ></vsf-icon-facebook>

          <vsf-icon-twitter
            v-if="element.label.toLowerCase() === 'twitter'"
          ></vsf-icon-twitter>

          <vsf-icon-pinterest
            v-if="element.label.toLowerCase() === 'pinterest'"
          ></vsf-icon-pinterest>

          <vsf-icon-you-tube
            v-if="element.label.toLowerCase() === 'youtube'"
          ></vsf-icon-you-tube>

          <vsf-icon-instagram
            v-if="element.label.toLowerCase() === 'instagram'"
          ></vsf-icon-instagram>
        </a>
      </div>
...
bottomLinks: VsfLinkType[];
    ...
    export default {
      name: 'vsf-footer',
      components: { 'vsf-icon-help': VsfIconHelp,'vsf-icon-chat': VsfIconChat,'vsf-icon-phone': VsfIconPhone,'vsf-icon-facebook': VsfIconFacebook,'vsf-icon-twitter': VsfIconTwitter,'vsf-icon-pinterest': VsfIconPinterest,'vsf-icon-you-tube': VsfIconYouTube,'vsf-icon-instagram': VsfIconInstagram },
      props: ["categories","socialMedia","companyName","contactOptions","bottomLinks"],
