  ...
  <div class="e-page">
    <div class="e-page-component">
      <VsfProductCardVertical
        ...
        :label="labelModel"
        :price="priceModel"
        :old-price="oldPriceModel"
        :size="sizeModel"
        :link="linkModel"
        :out-of-stock="outOfStockModel"
        :in-cart="inCartModel"
        :description="descriptionModel"
        :rating-value="ratingValueModel"
        :max-rating-value="maxRatingValueModel"
        :reviews="reviewsModel"
        :with-button="withButtonModel"
        :add-to-cart-label="addToCartLabelModel"
        :see-similar-label="seeSimilarLabelModel"
        @seeSimilar="handleSeeSimilar"
        @addToCart="handleAddToCart"
        @addToWishlist="handleAddToWishlist"
      >
        <template #badge>
          <VsfTag :badge="true" :size="sizeModel === 'lg' || sizeModel === 'base' ? 'base' : 'sm'" variant="info">
            <VsfIconHot :size="sizeModel === 'lg' || sizeModel === 'base' ? 'base' : 'xs'" />
            <span> -30% </span>
          </VsfTag>
        </template>
      </VsfProductCardVertical>
...
import VsfProductCardVertical, {
  VsfProductCardVerticalSizes,
} from '../../output/blocks/VsfProductCardVertical/VsfProductCardVertical.vue';
