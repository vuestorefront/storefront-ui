              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <hr class="mb-3.5" />
                    <ul>
                      <SfListItem v-for="item in items" :key="item.title" size="sm" role="none" class="md:!py-1.5">
                        <a
                          class="typography-text-base py-3 md:py-0 focus-visible:outline focus-visible:outline-offset focus-visible:rounded-sm"
                          :href="item.link"
                        >
                          {{ item.title }}
                        </a>
