  ...
  <nav class="inline-flex items-center text-sm font-normal font-body">
    <ol class="flex w-auto leading-none group md:flex-wrap">
      ...
      <li
        ...
        :key="item.name"
        icon=""
        class="peer hidden sm:flex items-center peer-[:nth-of-type(even)]:before:content-[url('https://storage.googleapis.com/sfui_docs_artifacts_bucket_public/production/fixture/chevron_right.svg')] peer-[:nth-of-type(even)]:before:inline-flex last-of-type:flex last-of-type:before:font-normal last-of-type:before:text-neutral-500 text-neutral-500 last-of-type:text-neutral-900 last-of-type:font-medium"
      >
        <SfLink
