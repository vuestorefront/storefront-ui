<template>
  <div
    role="alert"
    class="flex items-start md:items-center max-w-[600px] shadow-md bg-positive-200 pr-2 pl-4 ring-1 ring-positive-200 typography-text-sm md:typography-text-base py-1 rounded-xl"
  >
