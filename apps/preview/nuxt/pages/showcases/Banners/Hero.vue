<template>
  <div class="relative h-dvh w-dvh">
    ...
    <div class="h-full w-full max-w-[1536px] mx-auto p-4 md:px-10 flex flex-col justify-end md:justify-center text-white">
      ...
      <p class="typography-text-base md:typography-text-lg">
        The new sport collection is now in store.
      </p>
