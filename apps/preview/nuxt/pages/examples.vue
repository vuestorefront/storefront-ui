  ...
  <div class="e-page-examples">
    <div class="sidebar" :class="isOpen && 'sidebar-collapsed'" v-if="!isDocs">
      ...
      <ul class="sidebar-list">
        <li>
          <NuxtLink to="/examples/componentExample">Component Example Link</NuxtLink>
        </li>
        <li>
          <NuxtLink to="/examples/some">Some other component</NuxtLink>
        </li>
        <li>
          <NuxtLink to="/examples/VsfButton">Button</NuxtLink>
        </li>
      </ul>
    </div>
    <NuxtPage />
