<template>
  <ComponentExample :controls-attrs="controlsAttrs">
    <VsfButton type="button" @click="state.modelValue = !state.modelValue"> Open Modal </VsfButton>

    <VsfModal v-bind="state" v-model="state.modelValue" class="max-w-sm">
...
import { ref } from 'vue';
import { VsfModal, VsfButton } from '@storefront-ui/vue';
