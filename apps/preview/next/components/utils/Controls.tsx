...
export const prepareControls = <T extends {}>(
  controls: ControlsType,
  models: T
): ControlsProps<T> => {
...
export default function Controls<T extends { [k: string]: any }>(props: ControlsProps<T>) {
  ...
  function handleOnChangeValue<T extends HTMLElement>(e: ChangeEvent<T & { value: unknown }>, name: string) {
    setState({ [name]: e.target.value });
  }

  function handleJsonOnChangeValue<T extends HTMLElement>(e: ChangeEvent<T & { value: string }>, name: string) {
                    ...
                    switch (control.type) {
                      ...
                      case "boolean": return <div className="switch-wrapper">
                        <label className="switch">
                          <input
                            checked={props.state.get[control.modelName]}
                            value={props.state.get[control.modelName]}
