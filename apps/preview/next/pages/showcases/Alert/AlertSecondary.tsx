...
export default function AlertSecondary() {
  return (
    <div
      role="alert"
      className="flex items-center max-w-[600px] bg-secondary-100 pr-2 pl-4 ring-1 ring-secondary-200 typography-text-sm md:typography-text-base py-1 rounded-md"
    >
