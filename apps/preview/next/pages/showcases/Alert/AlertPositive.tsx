...
export default function AlertPositive() {
  return (
    <div
      role="alert"
      className="flex items-start md:items-center bg-positive-100 pr-2 pl-4 ring-1 ring-positive-200 typography-text-sm md:typography-text-base py-1 rounded-md"
    >
