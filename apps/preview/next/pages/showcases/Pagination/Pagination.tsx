        ...
        {!pages.find((page: number) => page === 1) && (
          <li>
            ...
            >
              <button
                type="button"
                className="px-4 py-3 rounded-md text-neutral-500 w-auto md:w-12 hover:bg-primary-100 hover:text-primary-800 active:bg-primary-200 active:text-primary-900"
              ...
              >
                <button
                  ...
                  className={classNames(
                    'px-4 py-3 text-neutral-500 w-auto md:w-12 rounded-md hover:bg-primary-100 hover:text-primary-800 active:bg-primary-200 active:text-primary-900',
        ...
        {!pages.find((page: number) => page === totalPages) && (
          <li>
            ...
            >
              <button
                type="button"
                className="px-4 py-3 rounded-md text-neutral-500 w-auto hover:bg-primary-100 hover:text-primary-800 active:bg-primary-200 active:text-primary-900 "
