import { SfProgressCircular, SfProgressSize } from '@storefront-ui/react';
...
function Example() {
  ...
  return (
    <ComponentExample controls={{ state, controls }}>
      <SfProgressCircular value={Number(state.get.value)} size={state.get.size} ariaLabel={state.get.ariaLabel} />
    </ComponentExample>
  );
}
