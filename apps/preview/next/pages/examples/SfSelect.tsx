import { SfSelect, SfSelectSize, SfSelectProps } from '@storefront-ui/react';
...
function Example() {
  const { state, controls } = prepareControls<
    SfSelectProps & { label: string; options: { label: string; value: string }[] }
  >(
    [
      {
        type: 'json',
  ...
  return (
    <ComponentExample controls={{ state, controls }}>
      <label>
        ...
        <SfSelect {...state.get} onChange={onChange}>
