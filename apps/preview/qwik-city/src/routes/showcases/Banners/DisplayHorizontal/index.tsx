        ...
        ({ image, title, subtitle, description, buttonText, backgroundColor, reverse, titleClass, subtitleClass }) => (
          ...
          >
            <a
              ...
              href="/"
            />
            <div class={{ 'flex justify-between overflow-hidden grow': true, 'flex-row-reverse': reverse }}>
              <div class="flex flex-col justify-center items-start p-6 lg:p-10 max-w-1/2">
                ...
                <h2 class={{ 'mb-4 mt-2 font-bold typography-headline-3': titleClass }}>{title}</h2>
