<template>
  <vsf-icon-base
    ...
    :ariaLabel="ariaLabel || 'triangle-up'"
    :content="useContent"
  ></vsf-icon-base>
</template>
...
export default {
  ...
  computed: {
    useContent() {
      return "<path d='M11.069 9.35a1 1 0 0 1 1.518 0l3.826 4.463a1 1 0 0 1-.76 1.65H8.002a1 1 0 0 1-.76-1.65l3.827-4.464Z'/>";
    },
  },
