<template>
  <vsf-icon-base
    ...
    :ariaLabel="ariaLabel || 'triangle-left'"
    :content="useContent"
  ></vsf-icon-base>
</template>
...
export default {
  ...
  computed: {
    useContent() {
      return "<path d='M8.359 11.059a1 1 0 0 0 0 1.518l4.463 3.826a1 1 0 0 0 1.651-.76v-7.65a1 1 0 0 0-1.65-.76L8.358 11.06Z'/>";
    },
  },
