<template>
  <vsf-icon-base
    ...
    :ariaLabel="ariaLabel || 'triangle-down'"
    :content="useContent"
  ></vsf-icon-base>
</template>
...
export default {
  ...
  computed: {
    useContent() {
      return "<path d='M11.24 15.114a1 1 0 0 0 1.52 0l3.825-4.463A1 1 0 0 0 15.825 9h-7.65a1 1 0 0 0-.76 1.65l3.826 4.464Z'/>";
    },
  },
