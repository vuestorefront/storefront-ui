<template>
  <vsf-icon-base
    ...
    :ariaLabel="ariaLabel || 'location-outline'"
    :content="useContent"
  ></vsf-icon-base>
</template>
...
export default {
  name: "vsf-icon-location-outline",
