<template>
  <vsf-icon-base
    ...
    :ariaLabel="ariaLabel || 'favorites-outline'"
    :content="useContent"
  ></vsf-icon-base>
</template>

<script lang="ts">
export interface VsfIconFavoritesOutlineProps {
...
export default {
  name: "vsf-icon-favorites-outline",
