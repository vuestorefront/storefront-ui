...
export default function VsfIconInstagram(props: VsfIconInstagramProps) {
  ...
  return (
    <VsfIconBase
      ...
      ariaLabel={props.ariaLabel || "instagram"}
      content={useContent()}
    />
  );
}
