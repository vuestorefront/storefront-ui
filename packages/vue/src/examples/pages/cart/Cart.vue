  ...
  <div id="cart">
    ...
    >
      <template #circle-icon>
        <SfCircleIcon
          class="my-cart__total-count sf-sidebar__circle-icon"
          :class="{ 'my-cart__total-count--is-hidden': totalItems < 1 }"
        >
          {{ totalItems }}
        </SfCircleIcon>
      </template>
      <div v-if="totalItems > 0" class="my-cart">
      ...
      <div v-else class="my-cart">
        ...
        <div class="empty-cart">
          <svg class="empty-cart__icon">
            <path
              opacity=".1"
              d="M7.175 136.363v2.871l-5.74-.633v-2.238h5.74z"
              fill="#fff"
            />
            <path
              d="M11.814 97.215l33.084-5.416v31.508l-31.434-1.655-1.65-24.438z"
              fill="#5ECE7B"
            />
            <path
              opacity=".05"
            ...
            />
            <path
              d="M44.899 91.799l39.385 2.986-2.18 27.42-37.205 1.102V91.799z"
              fill="#5ECE7B"
            />
            <path
              opacity=".1"
            ...
            />
            <path
              d="M56.972 82.346L44.9 91.963l39.27 2.986 6.417-9.841-33.614-2.762zM0 86.789l29.676-3.655L44.9 91.886l-32.964 5.427L0 86.789zM51.987 100.069V143l-15.435-1.594-6.714-.689-2.046-.216-6.71-.693-9.268-.956v-41.54L44.76 99.57l7.227.499zM84.283 94.95v41.816l-12.373 2.387-6.017 1.162-13.906 2.684V100.12l32.296-5.17z"
              fill="#5ECE7B"
            />
            <path
              opacity=".05"
              d="M84.283 94.95v41.816l-12.373 2.387-6.017 1.162-13.906 2.684V100.12l32.296-5.17z"
              fill="#000"
            />
            <path
              d="M0 106.221l11.904-8.909 40.085 2.718-5.901 9.886L0 106.221z"
              fill="#5ECE7B"
            />
            <path
              opacity=".1"
            ...
            />
            <path
              d="M84.136 94.95l-32.149 5.287 10.464 9.679 34.436-5.966-12.751-9z"
              fill="#5ECE7B"
            />
            <path
              opacity=".1"
              d="M84.136 94.95l-32.149 5.287 10.464 9.679 34.436-5.966-12.751-9zM71.681 138.701l-5.513 1.148v-5.678l5.164-1.411.35 5.941zM78.77 137.914l-5.514 1.148v-8.829l5.165-1.412.35 9.093z"
              fill="#fff"
            />
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M24.975 119.148c-.68 1.949-2.788 3.37-5.283 3.37a6.164 6.164 0 01-2.975-.747 4.334 4.334 0 108.258-2.623z"
              fill="#F1F2F3"
            />
            <mask
              id="a"
            ...
            <g mask="url(#a)">
              <circle cx="22.054" cy="124.094" r="1.575" fill="#1D1F22" />
              <path
                d="M17.065 123.999H17l2.2.938a4.227 4.227 0 001.659.341h.757a2.911 2.911 0 002.662-1.722v-.15a.147.147 0 00-.123-.145 2.747 2.747 0 00-1.277.111l-.379.127-1.18.296a3.592 3.592 0 01-1.653.017l-.462-.104a2.123 2.123 0 00-1.306.119 2.09 2.09 0 01-.833.172z"
                fill="#4D9AF5"
              />
            </g>
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M35.94 119.863c.485 2.033 2.485 3.66 5.001 3.871a6.193 6.193 0 002.938-.457 4.334 4.334 0 11-7.94-3.414z"
              fill="#F1F2F3"
            />
            <mask
              id="b"
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M36.24 119.367a4.726 4.726 0 007.79 3.339 4.334 4.334 0 11-7.79-3.339z"
                fill="#fff"
              />
            </mask>
            <g mask="url(#b)">
              <circle
                r="1.575"
                transform="matrix(-1 0 0 1 38.598 125.413)"
                fill="#1D1F22"
              />
              <path
                d="M41.904 125.414l.598.024A1.562 1.562 0 0144 126.999h-3.55a5 5 0 01-2.53-.687L35 124.599c0-.713.77-1.16 1.39-.806l1.643.939c.306.175.653.267 1.006.267h.868c.392 0 .781.072 1.148.212l.157.06c.221.085.455.133.692.143z"
                fill="#4D9AF5"
              />
            </g>
            <path
...
.empty-cart {
  ...
  &__title {
    margin: $spacer-extra-big 0 $spacer-big;
