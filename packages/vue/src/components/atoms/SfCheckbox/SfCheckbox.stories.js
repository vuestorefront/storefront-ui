...
const scssTableConfig = {
  ...
  tableBodyConfig: [
    ...
    ["$checkbox__checkmark-transition", "background-color 0.25s cubic-bezier(1, 0.5, 0.8, 1), border-color 0.25s cubic-bezier(1, 0.5, 0.8, 1) !default;", "transition for checkmark"],
    ["$checkbox__checkmark-size", "1.4375rem ", "size for checkmark"],
    ["$checkbox__checkmark-primary-color", "$c-green-primary", "primary color for checkmark"],
    ["$checkbox__checkmark-secondary-color", "$c-gray-secondary", "secondary color for checkmark"]
  ]
};
