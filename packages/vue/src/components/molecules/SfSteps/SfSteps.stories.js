...
const scssTableConfig = {
  ...
  tableBodyConfig: [
    [
      "$sf-steps__active-line-height-mobile",
      "0.1875rem",
      "Active line height mobile"
    ],
    [
      "$sf-steps__active-line-height-desktop",
      "0.125rem",
      "Active line height desktop"
    ],
    ["$sf-steps__active-line-coilor", "#1d1f22", "Active line color"],
    [
      "$sf-steps__default-border",
      "0.0625rem solid #f1f2f4",
      "Default border of steps line"
    ],
    ["$sf-steps__step-font-weight", "500", "Step font weight"],
    ["$sf-steps__step-font-size", "0.75rem", "Step font size"],
    ["$sf-steps__step-font-color", "$c-gray-secondary", "Step font color"]
  ]
};
