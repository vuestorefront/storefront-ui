...
export default {
  ...
  argTypes: {
    ...
    "back*": {
      ...
      description:
        "Named slot `back`. Due to name conflict in storybook docs, slot name has been changed to the name with asterisk. Use the `back` name if you want to use this slot. Use this slot to replace back button",
    },
    "title*": {
      table: {
        category: "Slots",
    ...
    "close*": {
      ...
      description:
        "Named slot `close`. Due to name conflict in storybook docs, slot name has been changed to the name with asterisk. Use the `close` name if you want to use this slot. Use this slot to replace close button",
    },
  },
  args: {
    title: "Dresses",
