...
<Meta title="Styleguides/Typography" />
...
{ 
  Object.keys(typography.size).map(key => (
    <div class="size-row">
      ...
      <div style={{ lineHeight: 1.2, fontWeight: 500, fontSize: typography.size[key] }}>
...
The sizes are defined [here](https://github.com/DivanteLtd/storefront-ui/blob/develop/packages/shared/styles/variables/_typography.scss)

## Icon sizes

<Story id="atoms-icon--icon-sizes" />
