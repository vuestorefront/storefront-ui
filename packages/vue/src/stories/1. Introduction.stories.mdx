...
This is legacy version of StorefrontUI. Check out the [LTS support](?path=/docs/storefrontui-lts-policy--page)
...
<ul class="websites">
  <li class="website-logo">
    <a href="https://shopping.airfrance.com/" target="_blank">
      <img src="https://shopping.airfrance.com/assets/images/logo.svg"/>
    </a>
  </li>
  <li class="website-logo">
    <a href="https://www.chromeburner.nl/" target="_blank">
      <img src="https://www.chromeburner.com/assets/logo.png" />
    </a>
  </li>
  <li class="website-logo">
...
<div className="link-list">
  <a
    className="link-item"
    href="?path=/story/getting-started-installation--page"
    target="_self"
  >
  ...
  <a
    className="link-item"
    href="?path=/story/getting-started-development-guide-colors--page"
    target="_self"
  >
  ...
  <a
    className="link-item"
    href="https://docs.storefrontui.io/v1/?path=/docs/components-atoms-arrow--common"
    target="_self"
  >
  ...
  <a className="link-item" href="https://discord.com/invite/TJpdzzN6q5" target="_blank">
  ...
  <a
    className="link-item"
    href="https://docs.storefrontui.io/v1/?path=/docs/contributing-guide-guide-become-a-contributor--page"
    target="_blank"
  >
  ...
  <a
    className="link-item"
    href="https://docs.storefrontui.io/v1/?path=/docs/team--page"
    target="_blank"
  >
