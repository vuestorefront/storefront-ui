...
<div className="link-list">
  ...
  <a
    className="link-item"
    href="https://docs.storefrontui.io/?path=/story/components-atoms-arrow--common"
    target="_self"
  >
  ...
  <a
    className="link-item"
    href="https://docs.storefrontui.io/?path=/story/contributing-guide-guide-become-a-contributor--page"
    target="_blank"
  >
  ...
  <a
    className="link-item"
    href="https://docs.storefrontui.io/?path=/story/team--page"
    target="_blank"
  >
