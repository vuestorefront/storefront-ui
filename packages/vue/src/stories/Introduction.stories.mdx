...
<div className="link-list">
  ...
  <a
    className="link-item"
    href="?path=/story/atoms-arrow--common"
    target="_self"
  >
  ...
  <a className="link-item" href="https://github.com/vuestorefront/storefront-ui/" target="_blank">
  ...
  <a
    className="link-item"
    href="https://docs.storefrontui.io/contributing/become-a-contributor"
    target="_blank"
  >
  ...
  <a className="link-item" href="https://docs.storefrontui.io/introduction/meet-the-team" target="_blank">
