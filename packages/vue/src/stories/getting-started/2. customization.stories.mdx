...
- **Clean, good looking code**
  CSS variables allow us to keep apply all the required styles without the need to use `::v-deep` or nest many properties and classes inside of parent selector.
  This is how the SCSS file for the same component looked before:
