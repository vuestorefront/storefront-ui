...
We can represent style guide as a set of global CSS variables. By using them, we are abstracting visual configuration from html and CSS structure to declarative variables. Thanks to this approach we can ship updates to Storefront UI without breaking your projects.
