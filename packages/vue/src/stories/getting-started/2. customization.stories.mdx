...
- **Clean, good looking code**
  CSS variables allow us to keep and apply all the required styles without need to use `::v-deep` or nest many properties and classes inside of parent selector.
