...
- [SfCimage](?path=/story/components-atoms-cloudinary-image--common) - Advanced image component with built-in Cloudinary support.
...
- [SfImage](?path=/story/components-atoms-image--common). See [Migration guide](/?path=/story/releases-v0-10-0-migration-guide--page) for more details.
- [Checkout page](?path=/story/pages-checkout--common) with the new design.
- Deprecate `badgeLabel` and `hasBadgeLabel` props from `SfIcon`. See [Migration guide](/?path=/story/releases-v0-10-0-migration-guide--page) for more details.
