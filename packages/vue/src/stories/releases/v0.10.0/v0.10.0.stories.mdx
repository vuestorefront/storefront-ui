...
- [SfImage](?path=/story/components-atoms-image--common). See [Migration guide](/?path=/story/releases-v0-10-0-migration-guide--page)
- [Checkout page](?path=/story/pages-checkout--common) with the new design.
- Deprecate `badgeLabel` and `hasBadgeLabel` props from `SfIcon`
