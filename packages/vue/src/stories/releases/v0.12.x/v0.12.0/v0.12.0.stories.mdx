...
- SfHeader: refactor removing inner components, changing props and removing most of the css properties
...
- SfImage, SfGallery, SfProductCard, SfProductCardHorizontal, SfBanner, SfHero: add posibility to use `nuxt-img` and `nuxt-picture` in SfImage component and add props to other components to configure `nuxt-image` module
