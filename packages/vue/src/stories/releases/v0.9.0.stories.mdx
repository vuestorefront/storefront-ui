...
| $font-size-extra-small-desktop: 0.75rem $font-size-small-mobile: 0.75rem | --font-size-extra-small: 0.75rem | --font-xs: 0.75rem      | --font-size--xs: 0.75rem  |
| $font-size-small-desktop: 0.875rem   $font-size-regular-mobile: 0.875rem | --font-size-small: 0.875rem      | --font-sm: 0.875rem     | --font-size--sm: 0.875rem |
| $font-size-regular-desktop: 1rem   $font-size-big-mobile: 1rem           | --font-size-regular: 1rem        | --font-base: 1rem       | --font-size--base: 1rem   |
| $font-size-big-desktop: 1.125rem   $font-size-extra-big-mobile: 1.125rem | --font-size-big: 1.125rem        | --font-lg: 1.125rem     | --font-size--lg: 1.125rem |
