...
export const Home = () => ({
  template: `<div id="home">
    ...
    <p>
      <b>StorefrontUI is currently in BETA which means it is not suitable for production! The package is stable
      but some breaking changes may occur.</b>
    </p>
    <h2>Join us!</h2>
    <p>StorefrontUI is a completely new approach for component libraries. It is oriented around customization 
    possibilities instead of out of the box possibilities. It's a great goal but it will take a lot of time 
    to achieve it only by ourselves. The project is open source and free to use. If you'd like to support 
    us and join the team, please write to me: <b> filip [at] vuestorefront.io </b> 🙂
    </p>
    <h2>How to start?</h2>
    <ol>
      <li> Add the package: 
    ...
    <p>You can find detailed information in 
    <a href="https://github.com/Divanteltd/storefront-ui/blob/master/packages/vue/docs/customization.md">this doc</a>.</p>
    <h2>Useful links</h2>
    <ul>
