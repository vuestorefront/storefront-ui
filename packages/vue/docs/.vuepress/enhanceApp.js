...
import SfQuantitySelector from "../../src/components/molecules/SfQuantitySelector/SfQuantitySelector.vue"
...
export default ({
  ...
  Vue.component("SfCarousel", SfCarousel);
  ...
  Vue.component("SfSidebar", SfSidebar);
