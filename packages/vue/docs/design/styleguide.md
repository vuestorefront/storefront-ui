...
.pad-x-4 |  padding-left: 4px; padding-right: 8px;
.pad-x-8 |  padding-left: 8px; padding-right: 8px;
.pad-x-16 |  padding-left: 16px; padding-right: 16px;
.pad-x-24 |  padding-left: 24px; padding-right: 24px;
.pad-x-32 |  padding-left: 32px; padding-right: 32px;
.pad-x-40 |  padding-left: 40px; padding-right: 40px;
.pad-x-80 |  padding-left: 80px; padding-right: 80px;
.pad-x-160 |  padding-left: 160px; padding-right: 160px;
.pad-y-4 |  padding-top: 4px; padding-bottom: 4px;
.pad-y-8 |  padding-top: 8px; padding-bottom: 8px;
.pad-y-16 |  padding-top: 16px; padding-bottom: 16px;
.pad-y-24 |  padding-top: 24px; padding-bottom: 24px;
.pad-y-32 |  padding-top: 32px; padding-bottom: 32px;
.pad-y-40 |  padding-top: 40px; padding-bottom: 40px;
.pad-y-80 |  padding-top: 80px; padding-bottom: 80px;
.pad-y-160 |  padding-top: 160px; padding-bottom: 160px;
