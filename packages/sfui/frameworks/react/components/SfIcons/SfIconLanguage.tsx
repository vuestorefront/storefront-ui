...
export default function SfIconLanguage({ size = SfIconSize.base, viewBox = '0 0 24 24', ...attributes }: SfIconProps) {
  return (
    <SfIconBase size={size} viewBox={viewBox} data-testid="language" {...attributes}>
      <path
        fillRule="evenodd"
