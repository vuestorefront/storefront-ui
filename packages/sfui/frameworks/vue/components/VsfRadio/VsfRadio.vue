...
<template>
  <input
    ...
    :value="value"
    :class="[
      'min-w-[20px] h-5 border-2 p-[3px] bg-clip-content rounded-full appearance-none cursor-pointer focus:outline focus:outline-offset-2 focus:outline-2 outline-secondary-600 disabled:border-disabled-500 disabled:cursor-not-allowed disabled:checked:bg-disabled-500 disabled:checked:border-disabled-500',
      invalid && !disabled
