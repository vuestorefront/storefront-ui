...
- **Mobile-first** All of the components are mobile-first to the extend following best design practices and UX guidelines. They highly change how they behave and look based on current screen size.
