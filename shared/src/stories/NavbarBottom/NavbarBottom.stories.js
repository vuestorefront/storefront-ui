...
const CommonNavbarWithIcon = (args, { argTypes }) => ({
  ...
  <li class="flex">
    ...
    >
      ...
      <span class="text-xs font-medium text-primary-500 mt-[2px] group-hover:text-primary-600 group-active:text-primary-600">Home</span>
    </a>
  </li>
  <li class="flex">
    <a
    ...
    <span class="text-xs font-medium text-primary-500 mt-[2px] group-hover:text-primary-600 group-active:text-primary-600">Products</span>
  </a>
  </li>
  <li class="flex">
    <a
    ...
    >
      ...
      <span class="text-xs font-medium text-primary-500 mt-[2px] group-hover:text-primary-600 group-active:text-primary-600">Search</span>
    </a>
  </li>
  <li class="flex">
    <a
      href="#"
      class="relative flex flex-col flex-1 items-center justify-center pt-3 pb-1 group hover:bg-primary-100 active:bg-primary-100"
    >
      <span class="relative">
        <svg
          width="25"
        ...
        <span class="text-xs font-medium text-primary-500 mt-[2px] group-hover:text-primary-600 group-active:text-primary-600">Cart</span>
      </span>
    </a>
  </li>
  <li class="flex">
    ...
    >
      ...
      <span class="text-xs font-medium text-primary-500 mt-[2px] group-hover:text-primary-600 group-active:text-primary-600">List</span>
    </a>
  </li>
</NavbarBottom>
`
...
const NavbarSmallWithCounter = (args, { argTypes }) => ({
  ...
  <li class="flex">
    <a
      href="#"
      aria-label="Products"
      class="flex flex-col flex-1 items-center justify-center px-[26px] py-[14px] group hover:bg-primary-100 active:bg-primary-100"
    >
      <svg
        width="25"
        height="24"
  ...
  <li class="flex">
    <a
      href="#"
      aria-label="Cart"
      class="relative flex flex-col flex-1 items-center justify-center px-[26px] py-[14px] group hover:bg-primary-100 active:bg-primary-100"
    >
      <span class="relative">
        <svg
          width="25"
        ...
        <span class="absolute bottom-3 left-3 px-1 py-[2px] text-[8px] leading-[8px] bg-secondary-700 rounded-lg font-body text-white font-medium border-2 border-white group-hover:border-primary-100 group-active:border-primary-100">
          123
        </span>
      </span>
    </a>
...
const BrandedNavbarWithIcon = () => ({
  ...
  <NavbarBottomBranded>
    <li class="flex">
      ...
      <span class="text-xs font-medium text-white mt-[2px]">Home</span>
    </a>
  </li>
  <li class="flex">
    <a
    ...
    >
      ...
      <span class="text-xs font-medium text-white mt-[2px]">Products</span>
    </a>
  </li>
  <li class="flex">
    <a
    ...
    >
      ...
      <span class="text-xs font-medium text-white mt-[2px]">Search</span>
    </a>
  </li>
  <li class="flex">
    <a
      href="#"
      class="flex-1 relative flex flex-col items-center justify-center pt-3 pb-1 group hover:bg-primary-600 active:bg-primary-600"
    >
      <span class="relative">
        <svg
          width="25"
        ...
        <svg class="absolute -top-2 -right-3" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M11 6C11 8.76142 8.76142 11 6 11C3.23858 11 1 8.76142 1 6C1 3.23858 3.23858 1 6 1C8.76142 1 11 3.23858 11 6Z" fill="white"/>
        </svg> 
      </span>
      <span class="text-xs font-medium text-white mt-[2px]">Cart</span>
    </a>
  </li>
  <li class="flex">
    <a
    ...
    >
      ...
      <span class="text-xs font-medium text-white mt-[2px]">List</span>
    </a>
  </li>
</NavbarBottomBranded>
`
...
const BrandedNavbarSmall = () => ({
  ...
  <li class="flex">
    <a
      href="#"
      aria-label="Products"
      class="flex-1 flex flex-col items-center justify-center px-[26px] py-[14px] group hover:bg-primary-600 active:bg-primary-600"
    >
      <svg
        width="25"
        height="24"
  ...
  <li class="flex">
    <button
      aria-label="Cart"
      class="flex-1 relative flex flex-col items-center justify-center px-[26px] py-[14px] group hover:bg-primary-600 active:bg-primary-600"
    >
      <span class="relative">
        <svg
          width="25"
        ...
        <span class="absolute bottom-3 left-3 px-1 py-[2px] text-[8px] leading-[8px] bg-white rounded-lg font-body font-medium border-2 border-brand group-hover:border-primary-600 group-active:border-primary-600">
          123
        </span>
      </span>
    </button>
