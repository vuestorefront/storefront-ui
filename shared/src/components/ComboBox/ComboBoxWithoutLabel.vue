<template>
  <div class="relative max-w-[320px] combobox combobox-list">
    <div
      class="inline-flex items-center w-full border rounded-md border-gray-300 hover:border-primary-400 focus-within:border-2 focus-within:border-primary-500 focus-within:p-0 active:border-2 p-[1px] active:p-0"
