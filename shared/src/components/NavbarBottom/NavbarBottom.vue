<template>
  <div class="grid grid-flow-col bg-white auto-cols-fr justify-items-stretch">
    <slot>
      <button class="flex flex-col items-center justify-center px-3 pt-3 pb-1 group hover:bg-primary-100 active:bg-primary-100">
        <svg
          width="25"
          height="24"
          viewBox="0 0 25 24"
      ...
      <button class="relative flex flex-col items-center justify-center px-3 pt-3 pb-1 group hover:bg-primary-100 active:bg-primary-100">
        <svg
          width="25"
          height="24"
          viewBox="0 0 25 24"
        ...
        <div class="absolute top-2 right-3 px-1 py-[2px] text-[8px] leading-[8px] bg-secondary-700 rounded-lg font-body text-white font-medium border-2 border-white group-hover:border-primary-100 group-active:border-primary-100">
          123
        </div>
