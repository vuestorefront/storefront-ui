      ...
      <slot>
        ...
        >
          <a
            ...
            :class="{ 'hover:!bg-primary-600 active:!bg-primary-600': branded, '!px-[26px] !py-[14px]': !withText }"
          >
            <svg
              width="25"
              height="24"
        ...
        >
          ...
          >
            <span class="relative">
              ...
              <span
                class="absolute bottom-3 left-3 px-1 py-[2px] text-[8px] leading-[8px] bg-secondary-700 rounded-lg font-body !text-white font-medium border-2 border-white group-hover:border-primary-100 group-active:border-primary-100"
                :class="{ '!text-black !bg-white !border-brand group-hover:!border-primary-600 group-active:!border-primary-600': branded }"
              >
                123
              </span>
            </span>
