<template>
  <div class="grid max-w-xs grid-cols-[50px_1fr] grid-flow-col-dense gap-x-2.5">
    <input
      id="radio2"
      v-focus
      type="radio"
    ...
    <label
      for="radio2"
      class="col-start-1 text-gray-900 cursor-pointer leading-6 text-base peer-required:after:content-['*'] peer-disabled:text-gray-900/40 peer-disabled:cursor-not-allowed font-body"
    > Label</label>
