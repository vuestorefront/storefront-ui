    ...
    >
      <slot name="image" v-bind="{ label, link, image, alt, outOfStock, badge, }">
        ...
        >
          ...
          >
            <path
              d="M11.0677 1.68642C11.0677 0.834202 9.97026 0.513011 9.48686 1.21949C5.05212 7.70169 11.3542 7.99352 11.3542 11.1446C11.3542 12.4204 10.3119 13.4527 9.0321 13.4359C7.77276 13.4198 6.77087 12.3699 6.77087 11.1105V8.04866C6.77087 7.27164 5.82306 6.89459 5.28738 7.45784C4.32882 8.46474 3.33337 10.1896 3.33337 12.2904C3.33337 16.0813 6.41746 19.1654 10.2084 19.1654C13.9993 19.1654 17.0834 16.0813 17.0834 12.2904C17.0834 6.19277 11.0677 5.37958 11.0677 1.68642Z"
              fill="white"
            />
          </svg>
        </TagBadge>
          ...
          <slot name="compare-button" v-bind="{ label, size }">
            ...
            >
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                class="fill-primary-500 group-hover:fill-primary-600 group-active:fill-primary-700"
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M16.6666 3.33464H12.3333C12 2.33464 11.0833 1.66797 9.99998 1.66797C8.91665 1.66797 7.99998 2.33464 7.66665 3.33464H3.33331C2.83331 3.33464 2.49998 3.66797 2.49998 4.16797C2.49998 4.66797 2.83331 5.0013 3.33331 5.0013H7.66665C7.99998 6.0013 8.91665 6.66797 9.99998 6.66797C11.0833 6.66797 12 6.0013 12.3333 5.0013H16.6666C17.1666 5.0013 17.5 4.66797 17.5 4.16797C17.5 3.66797 17.1666 3.33464 16.6666 3.33464ZM9.99998 5.0013C9.49998 5.0013 9.16665 4.66797 9.16665 4.16797C9.16665 3.66797 9.49998 3.33464 9.99998 3.33464C10.5 3.33464 10.8333 3.66797 10.8333 4.16797C10.8333 4.66797 10.5 5.0013 9.99998 5.0013Z"
                />
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M6.03449 6.52857C5.86238 6.1088 5.45367 5.83464 4.99998 5.83464C4.54629 5.83464 4.13757 6.1088 3.96546 6.52857L0.833313 14.168C0.833313 16.5013 2.66665 18.3346 4.99998 18.3346C7.33331 18.3346 9.16665 16.5013 9.16665 14.168L6.03449 6.52857ZM2.49998 14.168L4.99998 7.5013L7.49998 14.168H2.49998Z"
                />
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
      ...
      >
        <slot name="top">
          ...
          >
            ...
            >{{ price }}</span>
            <span
              class="text-xs font-normal leading-4 text-gray-500 line-through"
              :class="size === 'xs' ? 'ml-1' : 'ml-2'"
            >
              {{ oldPrice }}
            </span>
          </div>
        ...
        <slot name="add-button" v-bind="{ label, outOfStock, }">
          ...
          >
            ...
            >
              <path
                d="M14.7501 18.3346C13.8297 18.3346 13.0835 17.5884 13.0835 16.668C13.0835 15.7475 13.8297 15.0013 14.7501 15.0013C15.6706 15.0013 16.4168 15.7475 16.4168 16.668C16.4168 17.5884 15.6706 18.3346 14.7501 18.3346Z"
                fill="white"
              />
              <path
                d="M8.08348 18.3346C7.163 18.3346 6.41681 17.5884 6.41681 16.668C6.41681 15.7475 7.163 15.0013 8.08348 15.0013C9.00395 15.0013 9.75014 15.7475 9.75014 16.668C9.75014 17.5884 9.00395 18.3346 8.08348 18.3346Z"
                fill="white"
              />
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M0.833313 2.5013C0.833313 2.04106 1.20641 1.66797 1.66665 1.66797H3.58892C4.55904 1.66797 5.40076 2.33757 5.6189 3.28285L5.82316 4.16797H16.3157C17.671 4.16797 18.6655 5.44169 18.3368 6.75658L16.8785 12.5899C16.6466 13.5173 15.8133 14.168 14.8573 14.168H8.0777C7.10759 14.168 6.26586 13.4984 6.04772 12.5531L3.99492 3.65761C3.95129 3.46856 3.78295 3.33464 3.58892 3.33464H1.66665C1.20641 3.33464 0.833313 2.96154 0.833313 2.5013ZM6.20778 5.83464L7.67171 12.1783C7.71533 12.3674 7.88368 12.5013 8.0777 12.5013H14.8573C15.0485 12.5013 15.2152 12.3712 15.2616 12.1857L16.7199 6.35236C16.7856 6.08938 16.5867 5.83464 16.3157 5.83464H6.20778Z"
                fill="white"
              />
            </svg>
