<template>
  <div class="grid max-w-xs grid-cols-[24px_1fr] gap-x-2.5">
    <input
      ...
      :disabled="disabled"
      :valid="valid"
      class="peer w-[18px] h-[18px] border-2 border-gray-500 rounded-sm appearance-none cursor-pointer hover:border-primary-500 checked:bg-checked-checkbox bg-center checked:border-primary-500 disabled:border-gray-500/50 disabled:cursor-not-allowed outline-violet"
    ...
    >Label</label>
    <span :class="{'hidden': valid}" class="block col-start-2 mt-1 text-sm font-medium text-negative-600 font-body">Error message</span>
